...
## Business Rules
Software for maintenance tasks performed during a working day. This application has two types of users: Manager and Technician.
...
- **Notify manager of each task performed by the technician (Using RabbitMQ)**
